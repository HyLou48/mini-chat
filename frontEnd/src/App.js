...
import Invitation from "./components/utilisateur/invitations";
import Individu from "./components/individu/individu";
import Groupe from "./components/groupe/groupe";
import NouveauGroupe from "./components/groupe/ajoutNouveauGroupe";
		...
		<>
			...
			<BrowserRouter>
				<Routes>
					...
					<Route
						path="newUtilisateur/"
						element={<Deconnection Cmp={SEnregistrer} />}
					/>
					...
					<Route
						path="newGroupe/"
						element={<Authentification Cmp={NouveauGroupe} />}
					/>

					<Route
						path="invitation/:idAmis"
						element={<Authentification Cmp={Invitation} />}
					/>
					...
					<Route
						path="individu/:idAmis"
						element={<Authentification Cmp={Individu} />}
					/>

					<Route
						path="groupe/:id"
						element={<Authentification Cmp={Groupe} />}
					/>
